...
def main():
    ...
    try:
        ...
        # Read .env file generated by Terraform at deploy time
        ...
        if os.path.exists(env_path):
            ...
            log(f".env not found at {env_path}, using defaults")
            os.environ.setdefault("AWS_REGION", "us-east-1")

        kinesis_stream_arn = os.environ.get("KINESIS_STREAM_ARN",
            "arn:aws:kinesis:us-east-1:331504768406:stream/flight-radar-stream-flights")
        aws_region = os.environ.get("AWS_REGION", "us-east-1")
        log(f"KINESIS_STREAM_ARN: {kinesis_stream_arn}")
