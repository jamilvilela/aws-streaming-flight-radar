...
Requer connect string via env vars ou argumentos:
  export DB_HOST=flight-radar-stream-aurora.cluster-cgkowhehurn1.us-east-1.rds.amazonaws.com
  export DB_PORT=5432  
  export DB_NAME=flightradar
